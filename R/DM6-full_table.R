#' DM6_full_table.tsv
#'
#' This is an output file that has resulted from processing the DM6 genomic assembly with BUSCO.
...
#' The second line prefixed with a '#' and describes the lineage dataset.
#' The third line is prefixed with a '#' and is a header that describes the columns in subsequent rows.
#' \describe{
#'   \item{Busco id}{Unique identifier for BUSCO gene}
#'   \item{Status}{Copy number status for the gene: Fragmented, Complete, Duplicated, or Missing}
